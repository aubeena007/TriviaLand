    ...
    return (
        <div>
            { quiz[number] &&
                ...
                <>
                    <div className={styles.quizQ} dangerouslySetInnerHTML={{ __html: quiz[number].question }}></div>

                    <div className={styles.quizA}>
                        {quiz[number].options.map((item, index) => (
                            <div  className={styles.quizOpt}  key={index} dangerouslySetInnerHTML={{ __html: item }} onClick={pickAnswer}></div>
                        ))}
                    </div>
                </>
